...
public class ServoTuning extends OpMode {
    ...
    public void init() {
        ...
        robot = new Robot2024(hardwareMap, gamepad1, gamepad2, telemetry, OpModeSelection.SERVO_TUNING);

        telemetry.addData("Robot Status", "Initializing ServoTuning");
    }
    ...
    @Override
    public void start() {
        telemetry.addData("Robot Status", "Running ServoTuning");
        robot.initOpMode();
    }
    ...
    @Override
    public void stop() {
        telemetry.addData("Robot Status", "Stopped ServoTuning");
        robot.reset();
    }
}
