        ...
        if (DRIVE_CLASS.equals(MecanumDrive.class)) {
            dvf = hardwareMap -> {
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        MecanumDrive.MECANUM_DRIVE_PARAMS.inPerTick,
                        MecanumDrive.MECANUM_DRIVE_PARAMS.maxWheelVel,
                        MecanumDrive.MECANUM_DRIVE_PARAMS.minProfileAccel,
                        MecanumDrive.MECANUM_DRIVE_PARAMS.maxProfileAccel,
                        ...
                        md.lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(MecanumDrive.MECANUM_DRIVE_PARAMS.kS,
                                MecanumDrive.MECANUM_DRIVE_PARAMS.kV / MecanumDrive.MECANUM_DRIVE_PARAMS.inPerTick,
                                MecanumDrive.MECANUM_DRIVE_PARAMS.kA / MecanumDrive.MECANUM_DRIVE_PARAMS.inPerTick)
                );
            };
