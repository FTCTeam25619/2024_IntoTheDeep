...
/*
 * This class is a replication of the new updates to the FTCLib RevIMU class contained
 * in PR FTCLib/FTCLib#254.
 *
 * This should be removed once those changes are included in a new release of FTCLib.
 */
public class RevIMU {
